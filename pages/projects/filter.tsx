    ...
    return (
        <div className='mt-8 '>
            <div className='flex justify-start items-end w-full gap-2'>
                <div className={`px-2 flex justify-center items-center gap-4 py-4 cursor-pointer duration-300 ${filtersOpen ? 'bg-gray-2 hover:bg-gray-2 text-stone-800' : 'bg-brown-1 hover:bg-brown-2 text-white '}`}
