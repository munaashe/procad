    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta property="og:url" content={`https://procad.co.zw/projects/${project.slug}`} />
                ...
                {/* Canonical URL */}
                <link rel="canonical" href={`https://procad.co.zw/projects/${project.slug}`} />
            </Head>
            ...
            <Container className="w-full">
                ...
                <div className="w-full flex flex-col justify-center items-center">
                    <Container className="!p-0 flex flex-col items-center justify-center w-full md:w-[80%]">
                        ...
                        {project?.details && <div className='mt-12 lg:mt-24'>
